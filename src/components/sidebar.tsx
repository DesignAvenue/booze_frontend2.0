               ...
               <div className="sidenav-wrapper" id="sidenavWrapper">
                   ...
                   <ul className="sidenav-nav ps-0">
                       <li><a href="page-home.html">
                           <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-house-door"
                       ...
                       <li><a href="elements.html">
                           <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-folder2-open"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                               <path fill-rule="evenodd"
                                     d="M1 3.5A1.5 1.5 0 0 1 2.5 2h2.764c.958 0 1.76.56 2.311 1.184C7.985 3.648 8.48 4 9 4h4.5A1.5 1.5 0 0 1 15 5.5v.64c.57.265.94.876.856 1.546l-.64 5.124A2.5 2.5 0 0 1 12.733 15H3.266a2.5 2.5 0 0 1-2.481-2.19l-.64-5.124A1.5 1.5 0 0 1 1 6.14V3.5zM2 6h12v-.5a.5.5 0 0 0-.5-.5H9c-.964 0-1.71-.629-2.174-1.154C6.374 3.334 5.82 3 5.264 3H2.5a.5.5 0 0 0-.5.5V6zm-.367 1a.5.5 0 0 0-.496.562l.64 5.124A1.5 1.5 0 0 0 3.266 14h9.468a1.5 1.5 0 0 0 1.489-1.314l.64-5.124A.5.5 0 0 0 14.367 7H1.633z"/>
                           </svg>
                           Elements<span className="badge bg-danger rounded-pill ms-2">220+</span></a></li>
                       <li><a href="pages.html">
                           <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-collection"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                               <path fill-rule="evenodd"
                           ...
                           Pages<span className="badge bg-success rounded-pill ms-2">38</span></a></li>
                       <li className="affan-dropdown-menu"><a href="#">
                           <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-cart-check"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                               <path fill-rule="evenodd"
                       ...
                       <li>
                           <div className="night-mode-nav">
                               <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-moon"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                   <path fill-rule="evenodd"
                               ...
                               <div className="form-check form-switch">
                                   <input className="form-check-input form-check-success" type="checkbox"
                                          id="darkSwitch"/>
                               </div>
                           </div>
                       </li>
                       <li><a href="page-login.html">
                           <svg width="18" height="18" viewBox="0 0 16 16" className="bi bi-box-arrow-right"
                                fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                               <path fill-rule="evenodd"
